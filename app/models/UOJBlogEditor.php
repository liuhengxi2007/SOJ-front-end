...
class UOJBlogEditor {
	...
	function __construct() {
		...
		$this->label_text['title'] = UOJLocale::get('title');
		$this->label_text['tags'] = UOJLocale::get('tags') . ' (' . UOJLocale::get('separated by comma') . ')';
		$this->label_text['content'] = UOJLocale::get('content');
		$this->label_text['view blog'] = UOJLocale::get('view blog');
		$this->label_text['blog visibility'] = UOJLocale::get('blog visibility');
		$this->label_text['private'] = UOJLocale::get('private');
		$this->label_text['public'] = UOJLocale::get('public');
